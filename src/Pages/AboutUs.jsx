        ...
        <div className="content-container">
          ...
          <div className="content-columns">
            <div className="column bio-column">
              <p>Rochelle von Veh, the founder and creative soul behind **Vonvé Bridal Couture**. As a hands-on creative fashion designer in the South African industry, she captures the individuality that all brides hope to express. Rochelle created Vonvé Bridal Couture out of a sincere passion for the bridal industry and an unwavering belief that the bridal gown shopping experience should be special, peaceful, and an unforgettable experience from start to finish.</p>
