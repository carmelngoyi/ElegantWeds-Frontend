...
<img className='modal-image' src={dress.image_placeholder_url || dress.image} alt={dress.dress_name} />
...
<p className="quote-text">Becoming a bride is about the emotions woven into the journey.</p>
</div>
</div>
</section>
...
<div className="empty-message">No dresses found. Please add items to the "dresses" collection in MongoDB.</div>
